...
import { HourlyWeatherType } from 'shared/@types/WeatherResponse';
...
import { getInfoFromHourly } from 'shared/utils/transformWeather';
...
const HourlyCard = ({ weather, ...props }: Props) => {
	// Info Modal
	...
	return (
		<>
			...
			<WeatherInfoModal
				weather={getInfoFromHourly(weather)}
				isOpen={isOpen}
				onClose={onClose}
			/>
		</>
